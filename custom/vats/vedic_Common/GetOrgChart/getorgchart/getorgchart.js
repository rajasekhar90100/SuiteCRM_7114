...
getOrgChart.themes = {
    ...
    sara: {
        ...
        expandCollapseBtnRadius: 20,
        box: '<rect  x="0" y="0" height="250" width="500" rx="10" ry="10" class="get-box" />',
        text: '<text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]">[text]</text>',
        image: '<image xlink:href="[href]"  x="20" y="-20" height="170" preserveAspectRatio="xMidYMid slice" width="170"/>'
    },
    belinda: {
...
var currentLocation1 = currentLocation.split('?');
var URL = currentLocation1[0];
getOrgChart.prototype.showGridView = function() {
	window.open(URL+"?module=Users&action=UserReportsTo&return_module=Users",'_blank');
...
getOrgChart.prototype.highlightNode = function(c) {
    ...
    function b() {
		a.expandOrCollapse(c);
		a.expandOrCollapse(c);
        var d = a.nodes[c];
		var id = d.id;
		$('[data-node-id="'+id+'"]').children().first().css("fill","lightblue");
