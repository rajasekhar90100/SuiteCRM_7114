...
jQuery.fn.flexdatalist = function(e, t) {
        ...
        return this.each(function(e) {
            ...
            this.init = function() {
                    ...
                    if (i.isObject(e))
                        if (this.isJSON() || this.isMixed())
                            if (delete e.name_highlight, $.isArray(r)) {
                                for (var n = {}, s = 0; s < r.length; s++) i.isDefined(e, r[s]) && (n[r[s]] = e[r[s]]);
                                t = this.toStr(n)
                            } else t = this.toStr(e);
                ...
                split: function(e) {
                    if ("string" == typeof e && (e = [$.trim(e)]), i.options.get("searchByWord"))
                ...
                items: function(e, a) {
                    ...
                    for (var n = 0; n < e.length && !(r > 0 && r === n); n++) this.item(e[n]).appendTo(a);
                ...
                item: function(e) {
                    for (var t = $("<li>").data("item", e).addClass("item"), a = i.options.get(), r = a.visibleProperties, n = 0; n < r.length; n++) {
                        ...
                        if (s.indexOf("{") > -1) {
                            ...
                            var u = {};
                            if (s === a.iconProperty) u = $("<img>").addClass("item item-" + s).attr("src", e[s]);
                            else {
                ...
                clear: function() {
                    if (i.cache.isSupported()) {
                        for (var e in localStorage)(e.indexOf(s) > -1 || e.indexOf("global") > -1) && localStorage.removeItem(e);
                        localStorage.clear()
                    }
                },
                gc: function() {
                ...
                keyGen: function(e, t, i) {
                    ...
                    var a, r, n = void 0 === t ? 2166136261 : t;
                    for (a = 0, r = e.length; r > a; a++) n ^= e.charCodeAt(a), n += (n << 1) + (n << 4) + (n << 7) + (n << 8) + (n << 24);
