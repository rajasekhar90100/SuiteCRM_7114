...
/**
  ...
  * Created By => Udaykiran (Created On Nov-15-2017)
  * Modified By => Udaykiran (Modified On Jul-15-2018)
  * COMMENT => Code to update the audit table of profiles if the field in auidted
  */
...
$relateFields = array('hirer_1_c','ml_1_c','ml_2_c','hirer_2_c','primary_marketer_c','secondary_marketer_c','sales_c','rl_c','hl_c');
