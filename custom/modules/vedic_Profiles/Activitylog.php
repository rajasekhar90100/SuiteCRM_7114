...
/*   
	...
	* Modified By => Rajasekhar (Modified On Feb-13-2018)
...
while ($row2 = $db->fetchByAssoc($result2)) {
    if (empty($columns)) {
        $columns = array_keys($row2);
			...
			<h2 style="text-align:center;font-size: 20px;"><b>Profile History Report
			    </b>
			</h2>
