<?php
/**
  * FileName => profilesMfile.php
  * Created By => Udaykiran (Created On Feb-15-2018)
  * Modified By => Udaykiran (Modified On Feb-15-2018)
			...
			if(($gname[$i]!='')) {		
				if($gname[$i] != 'undefined')
				{
					...
					$query = "SELECT documents.id AS id,
							...
							INNER JOIN documents ON vedic_candidates_documents_1_c.vedic_candidates_documents_1documents_idb = documents.id INNER JOIN vedic_profiles_documents_1_c ON vedic_candidates_documents_1documents_idb = vedic_profiles_documents_1_c.vedic_profiles_documents_1documents_idb WHERE documents.deleted= '0'  AND vedic_candidates_documents_1_c.deleted = '0'
							   AND vedic_profiles_documents_1_c.deleted = '0'
							  AND vedic_profiles_documents_1_c.vedic_profiles_documents_1vedic_profiles_ida ='$profID'
					...
					else
					{
						...
						$target->vedic_profiles_documents_1_name = $profName;
