...
/**  
   ...
   * Created By => Udaykiran (Modified On Mar-26-2018) 
   * Modified By => Maneesha (Modified On Apr-04-2018) 
   * COMMENT => Code to upload the multiple files for Profiles
   */
	...
	$("#uploadForm").on("submit",(function(e) {
		...
		if(counter != 0)
		{
			...
			if(ProfId == null)
			{
				...
				$.ajax({
					url:"index.php?entryPoint=UploadMFile&ProfId="+ProfId,
					type: "POST",
...
<h2>Multiple File Upload for Profile Documents</h2>
<br/>
