	...
	function Submit(&$bean, $event, $arguments){
		...
		*/
			...
			if($event == 'after_relationship_delete'){
				...
				echo __FILE__ . ":" . __LINE__ . ": ".$arguments['related_bean']->id;

				$sel_job_id = "SELECT vedic_job_vedic_submissions_1vedic_job_ida FROM vedic_job_vedic_submissions_1_c WHERE vedic_job_vedic_submissions_1vedic_submissions_idb='".$arguments['related_bean']->id."' AND deleted =0  ";
				...
				if(!empty($job_id)){
					...
					$update_vedic_job_vedic_submissions = "UPDATE vedic_job_vedic_submissions_1_c SET deleted =1 WHERE vedic_job_vedic_submissions_1vedic_submissions_idb='".$arguments['related_bean']->id."' ";
