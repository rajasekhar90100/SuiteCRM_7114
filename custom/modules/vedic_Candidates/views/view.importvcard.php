...
class  vedic_CandidatesViewImportvcard extends ViewImportvcard
{
	...
	public function display()
    {
      ...
      print '<style type="text/css">.utilsLink{ display:none; }</style>';
			parent :: display();
        ...
        $params = array();
        $params[] = "<a href='index.php?module=vedic_Candidates&action=index'>{$mod_strings['vedic_Candidates']}</a>";
        $params[] = $app_strings['LBL_IMPORT_VCARD_BUTTON_LABEL'];
		echo getClassicModuleTitle($mod_strings['vedic_Candidates'], $params, true);
