...
class vedic_Employees extends Person
{
    public $new_schema = true;
    public $module_dir = 'vedic_Employees';
    public $object_name = 'vedic_Employees';
    public $table_name = 'vedic_employees';
    ...
    public $birth_dept;
    public $hire_date;
    public $last_hire_date;
    public $quiting_date;
    public $trigram;
    public $rib_banq_number;
    public $rib_guichet_number;
    public $rib_account;
    public $rib_key;
    public $employee_number;
    public $entire_rib_n;
    public $birth_date;
    public $asset_number_1;
    public $pis_number_2;
    public $employee_nationality;
    public $marital_situation;
    public $rib_bank_location;
    public $syntec;
    public $holiday_balance;
    public $rtt_balance;
    public $actual_employee;
    public $holiday_reference;
    public $gross_incomes;
    public $currency_id;
    public $rtt_reference;
    public $flyingblue;
    public $billable;
