...
/**
  ...
  * Created By => Maneesha (Created On Jan-03-2018)
  * Modified By => Maneesha (Modified On Jan-03-2018)
  * COMMENT => popup view for all modules.
  */
...
class ViewPopup extends SugarView{
	...
	/**
	  ...
	  * Modified By => Maneesha (Modified On Jan-03-2018)
	  * COMMENT => Added another condition for in "else" condition to call custom audit file.
	  */
